...
const { topicsOfInterest } = require('./topicsOfInterest');
const { updateTopicsOfInterest } = require('./updateTopicsOfInterest');
...
const topicInterest = (req, res) => topicsOfInterest(req, res, db);
const updateTopicInterest = (req, res) => updateTopicsOfInterest(req, res, db);
